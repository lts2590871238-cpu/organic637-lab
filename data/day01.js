    ...
    questions: [
      ...
      },
      {
        ...
        explanationLayers: {
          ...
          why: '结构式能直接告诉你连接关系与官能团；这张结构卡只画了谁和谁相连，没有画出 –OH 是朝向你还是背向你，所以不能只靠它判断三维朝向。',
          full: '这一步训练“事实与推测分开”：结构上可直接看到苄位 –OH 和芳基 Br，也能数出碳骨架；但三维朝向、责任归属和路线来源都需要额外证据。'
        },
        options: [
          { id: 'oh', label: '苄位 –OH' },
          { id: 'br', label: '芳环上的 Br' },
          { id: 'direction', label: '图里已经明确画出 –OH 朝向你还是背向你' }
        ],
        answer: ['br','oh']
      },
      {
